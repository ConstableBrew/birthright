window.domains = {
    ...
    regents: {
        ...
        'Nilsvaar': {
            ...
            vassals: ['Bjorn', 'Daegandal', 'Gautrek Raknarsson', 'Lars Pedresen', 'Rainer', 'Rhaegar Taengress', 'Ruvin', 'Selena Clairmonte', 'Sigfrid', 'Thorin Ungarth', 'Ulrich']
        },
        'Thorin Ungarth': {
            key: 'Thorin Ungarth',
            name: 'Thorin Ungarth',
    ...
    provinces: {
        ...
        Kvigmarheim: {
            ...
            trade: {
                'Kantswatch': {
                    'guilds': [{ 'Nilsvaar': 2 }, { 'Volse Redbedtehr': 2 }],
                    'contested': true,
                    'cultures': ['Brecht', 'Rjurik']
                },
                'Chelyatev': {
                    'guilds': [{ 'Nilsvaar': 2 }, { 'Markovlan Saravok': 1 }],
                    'contested': true,
                    'cultures': ['Rjurik', 'Vos']
                }
            }
        ...
        Sjalikfjord: {
            ...
            military: {
                'Lars Pedresen': [{ name: 'Irregulars' }, { name: 'Longship', notes: 'Skyggehjertet' }]
            }
        },
        Virskaap: {
            key: 'Virskaap',
        ...
        'Zeph-na': {
            ...
            military: {
                'Selena Clairmonte': [{ name: 'Irregulars' }]
            }
        },
        Nulthan: {
            key: 'Nulthan',
